...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in approved_users:
        if not await is_member(update, context):
            join_message = "❌ You must join both channels before using this bot:\n"
            join_message += "➡️ [Join Channel 1](https://t.me/paidserver07)\n"
            join_message += "➡️ [Join Channel 2](https://t.me/LostBoiServer)"
